...
opts = {
 "py2exe": {
   "packages": ["encodings", "nevow", "nevow.flat", "cProfile", "functools", "csv", "libxml2", "robotparser", "chardet", "lxml", "feedparser", "BeautifulSoup", "oauth2client", "google-api-python-client"],
