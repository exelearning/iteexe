...
class ScormPage(Page):
    ...
    def render(self):
        ...
        # iDevice icons path
        html = html.replace('class="iDevice_header" style="background-image:url(/style/'+self.node.package.style+'/icon_', 'class="iDevice_header" style="background-image:url(icon_')
