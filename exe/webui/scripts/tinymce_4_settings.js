...
var $exeTinyMCE = {
	...
	buttons2 : "undo redo | cut copy paste pastetext | pastecode | searchreplace | link unlink anchor | removeformat | insertdatetime hr | charmap",
	buttons3 : "template | table | code help",
	// To add:
		// buttons2 : "pastehtml,tooltip,image,media,exeeffects,exegames,cleanup,cite,abbr,acronym,del,ins,attribs,nonbreaking,charmap,exemath,styleprops",
		// buttons3 : "codemagic",	
