				...
				body: [
					{
						...
						items: [
							...
							{
								type: 'label', 
								text: _('You can also check the Properties - Export - Math content option and just type LaTeX code directly into the editor.')
							},
							{
								type: 'textbox',
								name: 'src',
						...
						items: [
							{
								...
								html   : '\
									...
									<ul style="margin-left:2em">\
										...
										<li>'+_('You can also check the Properties - Export - Math content option and just type LaTeX code directly into the editor.')+'</li>\
									</ul>\
