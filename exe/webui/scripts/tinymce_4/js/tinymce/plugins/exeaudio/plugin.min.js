 ...
 * Author: Manuel Mayo (https://github.com/ManuelMayoSdweb) for BirtLH (http://www.ulhi.hezkuntza.net/) and http://exelearning.net/
 * Author: Ignacio Gros (http://gros.es/) for http://exelearning.net/
 *
 * License: http://creativecommons.org/licenses/by-sa/4.0/

 * Button icon by Google (https://material.io/tools/icons/), available under Apache license version 2.0. (http://www.apache.org/licenses/LICENSE-2.0) 
 ...
 * It requires some server side actions incluided in eXe (see $exeAuthoring.fileUpload).
 * Original iDevice and server side code by Manuel Mayo.
...
var eXeAudioRecorder = {
	...
	getInstructions: function(){
		...
		var str = _("Use the %s option after recording to define the authorship or the audio title.");
			str = str.replace('%s','<img src="/scripts/tinymce_4/js/tinymce/plugins/exeaudio/img/exemedia.png" alt="'+alt+'" title="'+alt+'" width="16" height="16" style="margin:0 2px" />');
		return str;
	},
			...
			.then(function(devices) {
				devices.forEach(function(device) {
					if (device.kind == "audioinput") {
						...
						if (device.label!="") {
							item = {text: device.label, value: device.deviceId}
						}
	...
	enableAudioRecorder: function(editor,win) {
		...
		function uploadAudioFile() {
			...
			blob.name = Math.random().toString(36).substring(2, 15)+"."+ext;
			$exeAuthoring.fileUpload(audioField,blob);
					...
					},
					{
						...
						items: [
							...
							},							
							{
								type: 'container',
								id: 'exeAudioViewer',
								html: '<div style="height:40px;margin-top:10px"><audio id="EAR_audioField" preload="metadata"></audio></div>'
							}
						]
					},
					{
