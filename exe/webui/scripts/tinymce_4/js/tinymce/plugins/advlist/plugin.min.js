// The New eXeLearning: Compare this file with the original plugin.js (TinyMCE Dev Package)
...
var advlist = (function () {
  ...
  var applyListFormat = function (editor, listName, styleValue) {
    ...
    var list = dom.getParent(sel.getNode(), 'ol,ul');
  ...
  var getNumberStyles = function (editor) {
    // The New eXeLearning (add "decimal" to the list)
    var styles = editor.getParam('advlist_number_styles', 'default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman,decimal');
  ...
  var toMenuItems = function (styles) {
    return global$1.map(styles, function (styleValue) {
      ...
      // The New eXeLearning
      if (styleValue=="decimal") text = _("Automatic Numbering");
      // / The New eXeLearning
