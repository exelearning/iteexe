...
tinymce.PluginManager.add('toggletoolbars', function(editor, url) {
	...
	editor.on( 'init', function() {
		...
		// Except in multiple-visible mode (to review)
		if ($exeTinyMCE.mode == "multiple-visible") tinymceToolbarToggler.cookie.set("tinymceToolbarTogglerPreference", "visibleToolbars", 30);			
