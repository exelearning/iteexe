...
tinymce.PluginManager.add('exemedia', function(editor, url) {	
			...
			if (data.type == "iframe") {
				...
				html = (
					'<video width="' + data.width + '" height="' + data.height + '"' + (data.poster ? ' poster="' + data.poster + '"' : '') + ' controls="controls">\n' +
						...
						(data.sourcesbt && data.sourcesbt !== "" ? '<track label="' + _("Sutbtitles") + '" kind="subtitles" srclang="" src="' + data.sourcesbt + '" default />\n' : '') +
					'</video>'
				);
			}
		}
	...
	function updateHTMLSBT(code,sbt){
		...
		jQuery("video",div).each(function(){
			...
			if(!hassbt){
				$media.append('<track label="' + _("Sutbtitles") + '" kind="subtitles" srclang="" src="' + sbt + '" default />')
				return div.html();
			}
		});
		return div.html();
