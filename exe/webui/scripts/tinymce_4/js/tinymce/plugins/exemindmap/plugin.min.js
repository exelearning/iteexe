        ...
        openDialog : function(){
            ...
            win = editor.windowManager.open({
                ...
                body: [
                    {
                        ...
                        size: 40,
                        readonly: true,
                        placeholder: _("Use the editor to create a new mind map...")
                    },
                    {
                        hidden: true,
                        type: 'textbox', 
                ...
                onsubmit: function(e) {  
                    ...
                    var img = win.find("#mindmapImg")[0].value();
                    ...
                    var a1 = "";
                    var a2 = "";
                    if (win.find("#linkToFullSizeImage")[0].checked()) {
            ...
            if (c=="exe-mind-map") {
                ...
                if (img.length==1 && code.length==1) {
                    ...
                    win.find("#mindmapImg")[0].value(img.attr("src"));
                    var data = code.html();
                    win.find("#mindmapCode")[0].value(data);
                    top.mindmapEditor.data = data;
                    // Dimensions
                    win.find("#originalWidth")[0].value(img.width());
                    win.find("#originalHeight")[0].value(img.height());
                    win.find("#width")[0].value(img.width());
                    win.find("#height")[0].value(img.height());
                    if (title.length==1) {
			...
			// Provisional solution to change the button text color
			var editorBtn = $("#mindmapEditorButton");
			editorBtn.css({
				"background" : "#2276D2",
				"border-color" : "#2276D2"
			});
			$(".mce-txt",editorBtn).css("color","#fff");
