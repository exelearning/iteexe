...
tinyMCE.init({
	...
	editor_selector : "mceEditor",
        plugins : "style,layer,table,save,advhr,advimage,advlink,emotions,iespell,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,exemath",
	theme : "advanced",
	...
	theme_advanced_toolbar_location : "top",  
        ...
        theme_advanced_buttons3 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,formatselect,codigo,glosario,idioma,cite,abbr,acronym,attribs,|,visualchars,nonbreaking,template,separator,cut,copy,paste,pastetext,pasteword,help",
