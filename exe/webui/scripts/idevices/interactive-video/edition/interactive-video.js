...
var $exeDevice = {
	...
	ci18n : {
		"start" : [_("Start"), c_("Start")],
		"results" : [_("Results"), c_("Results")],
		"slide" : [_("Slide (frame)"),c_("Slide (frame)")],
		"score" : [_("Score"), c_("Score")],
		"seen" : [_("Seen"),c_("Seen")],
		"total" : [_("Total"),c_("Total")],
		"seeAll" : [_("see all the slides and answer all the questions"),
				   c_("see all the slides and answer all the questions")],
		"noSlides" : [_("This video has no interactive slides."),
					 c_("This video has no interactive slides.")],
		"goOn" : [_("Continue"),c_("Continue")],
		"error" : [_("Error"),c_("Error")],
		"dataError" : [_("Incompatible code"),c_("Incompatible code")],
		"onlyOne" : [_("Only one interactive video per page."), c_("Only one interactive video per page.")],
		"cover" : [_("Cover"), c_("Cover")],
		"fsWarning" : [_("Exit the fullscreen mode (Esc) to see the current slide"),
					  c_("Exit the fullscreen mode (Esc) to see the current slide")],
		"right" : [_("Right!"), c_("Right!")],
		"wrong" : [_("Wrong"), c_("Wrong")],
		"sortableListInstructions" : [_("Drag and drop or use the arrows."),
									 c_("Drag and drop or use the arrows.")],
		"up" : [_("Move up"), c_("Move up")],
		"down" : [_("Move down"), c_("Move down")],
		"rightAnswer" : [_("Right answer:"), c_("Right answer:")],
		"notAnswered" : [_("Please finish the activity"), c_("Please finish the activity")],
		"check" : [_("Check"), c_("Check")],
		"newWindow" : [_("New Window"), c_("New Window")]
	},
