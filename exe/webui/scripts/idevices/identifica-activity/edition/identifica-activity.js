    ...
    createForm: function () {
        var path = $exeDevice.iDevicePath,
			...
			<div id="gameQEIdeviceForm">\
                <div class="exe-idevice-info">'+_("Create activities in which the players, with some clues, will have to guess a character, an object or the solution to a problem.")+' <a href="https://descargas.intef.es/cedec/exe_learning/Manuales/manual_exe29/identifica.html" hreflang="es" target="_blank">'+_("Use Instructions")+'</a></div>\
