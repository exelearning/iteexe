...
var $exeDevice = {
	...
	ci18n: {
		...
		"msgShowWords": _("Show solutions"),
		"msgAll": _("All"),
        "msgUnanswered": _("Not answered"),
	},
	colors: {
		black: "#1c1b1b",
		blue: '#0099cc',
					...
					<fieldset class="exe-fieldset exe-fieldset-closed">\
						...
						<div>\
							...
							<p>\
								...
								<label for="roscoEEvaluation"><input type="checkbox" id="roscoEEvaluation"> ' + _("Progress report") + '. </label> \
								<label for="roscoEEvaluationID">' + _("Identifier") + ':\
