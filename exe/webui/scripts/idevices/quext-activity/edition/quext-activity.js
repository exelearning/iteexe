    ...
    createForm: function () {
        var path = $exeDevice.iDevicePath,
			...
			<div id="gameQEIdeviceForm">\
                <div class="exe-idevice-info">'+_("Create activities in which students see a video, image or text and they have to choose the right answer.")+' <a href="https://youtu.be/YPJ3ZSBpw_A" hreflang="es" rel="lightbox">'+_("Use Instructions")+'</a></div>\
