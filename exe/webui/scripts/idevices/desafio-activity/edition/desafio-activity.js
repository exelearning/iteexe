...
var $exeDevice = {
    ...
    createForm: function () {
        var path = $exeDevice.iDevicePath,
			...
			<div id="desafioIdeviceForm">\
                <div class="exe-idevice-info">'+_("Create escape room type activities in which players will have to complete trials before solving the final challenge.")+' <a href="https://descargas.intef.es/cedec/exe_learning/Manuales/manual_exe29/desafo.html" hreflang="es" target="_blank">'+_("Use Instructions")+'</a></div>\
    ...
    addEvents: function () {
        ...
        $("#desafioEEvaluationHelpLnk").click(function () {
