    ...
    createForm: function () {
        ...
        var path = $exeDevice.iDevicePath,
			...
			<div id="gameQEIdeviceForm">\
                <div class="exe-idevice-info">' + _("Create word search games with additional text, images or sound.") + ' <a href="https://youtu.be/cs99CDs7xMw" hreflang="es" rel="lightbox"  target="_blank">' + _("Use Instructions") + '</a></div>\
