...
var $eXeAdivina = {
        ...
        <div class="adivina-GameContainer" id="adivinaGameContainer-' + instance + '">\
            ...
            <div class="adivina-Multimedia" id="adivinaMultimedia-' + instance + '">\
                <div class="adivina-Protector" id="adivinaProtector-' + instance + '"></div>\
                ...
                <div class="adivina-GameOver" id="adivinaGamerOver-' + instance + '">\
                    <div class="adivina-DataGameImage">\
                    ...
                    <div class="adivina-DataGameScore" id="adivinaDataGame-' + instance + '">\
            ...
            <div class="adivina-AuthorLicence" id="adivinaAutorLicence-' + instance + '">\
            ...
            <div class="adivina-StartGame"><a href="#" id="adivinaStartGame-' + instance + '"></a></div>\
            <div class="adivina-Question" id="adivinaQuestion-' + instance + '">\
                <div class="sr-av">' + msgs.msgAnswer + ':</div>\
                <div class="adivina-Prhase" id="adivinaEPhrase-' + instance + '"></div>\
                ...
                <div class="adivina-DivReply" id="adivinaDivResponder-' + instance + '">\
                    ...
                    <input type="text" value="" class="adivina-EdReply" id="adivinaEdAnswer-' + instance + '" autocomplete="off">\
            ...
            <div class="adivina-DivInstructions" id="adivinaDivInstructions-' + instance + '">' + msgs.msgWrote + '</div>\
        </div>\
    </div>\
    ' + this.addButtonScore(instance);
        ...
        drawPhrase: function (phrase, definition, nivel, type, casesensitive, instance) {
            $('#adivinaEPhrase-' + instance).find('.adivina-Word').remove();
            ...
            for (var i = 0; i < phrase_array.length; i++) {
                ...
                if (cleanWord != '') {
                    $('<div class="adivina-Word"></div>').appendTo('#adivinaEPhrase-' + instance);
                    for (var j = 0; j < cleanWord.length; j++) {
                        ...
                        $('#adivinaEPhrase-' + instance).find('.adivina-Word').last().append(letter);
                    }
                }
            }
        ...
        addEvents: function (instance) {
            ...
            $('#adivinaStartGame-' + instance).text(mOptions.msgs.msgStartGame);
        ...
        gameOver: function (type, instance) {
            ...
            $('#adivinaEPhrase-' + instance).find('.adivina-Word').hide();
            $('#adivinaEdAnswer-' + instance).val('');
            $('#adivinaEdAnswer-' + instance).hide();
            $('#adivinaImage-' + instance).hide();
        ...
        showQuestion: function (i, instance) {
            ...
            $('#adivinaEPhrase-' + instance).find('.adivina-Letter').css('color', $eXeAdivina.borderColors.blue);
            $eXeAdivina.drawPhrase(mQuestion.word, mQuestion.definition, $eXeAdivina.options[instance].percentageShow, 0, $eXeAdivina.options[instance].caseSensitive, instance);
            $('#adivinaEdAnswer-' + instance).val("");
        ...
        answerQuestion: function (instance) {
            var mOptions = $eXeAdivina.options[instance],
                ...
                solution = $.trim(question.word);
                    ...
                    $('#adivinaBtnReply-' + instance).prop('disabled', true); $('#adivinaBtnMoveOn-' + instance).prop('disabled', true); $('#adivinaEdAnswer-' + instance).prop('disabled', true);
                    if (!mOptions.gameActived) {
                        return;
                    }
                    ...
                    var type = $eXeAdivina.updateScore(solution == answord, instance),
                        percentageHits = (mOptions.hits / mOptions.numberQuestions) * 100; mOptions.activeCounter = false;
                    var timeShowSolution = 1000;
