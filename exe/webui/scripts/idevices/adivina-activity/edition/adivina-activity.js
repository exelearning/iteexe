    ...
    createForm: function () {
        var path = $exeDevice.iDevicePath,
			...
			<div id="gameQEIdeviceForm">\
                <div class="exe-idevice-info">'+_("Cree actividades o juegos en los que, dada la definición de una palabra, se solicita a nuestro alumnado la propia palabra completando las letras que faltan.")+' <a href="https://youtu.be/aKdBRClanYk" hreflang="es" rel="lightbox">'+_("Aprenda a usar este iDevice.")+'</a></div>\				<div class="exe-form-tab" title="' + _('General settings') + '">\
