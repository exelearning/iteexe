...
var $exeDevice = {
    ...
    createForm: function () {
        var path = $exeDevice.iDevicePath,
            ...
            <div class="exe-idevice-info">' + _("Create card memory games with images, sounds or rich text.") + ' <a href="https://youtu.be/ADrG4vz2W0Y" hreflang="es" rel="lightbox"  target="_blank">' + _("Use Instructions") + '</a></div>\
                ...
                <fieldset class="exe-fieldset exe-fieldset-closed">\
                    ...
                    <div>\
                        ...
                        <p>\
							...
							<label for="flipcardsEEvaluation"><input type="checkbox" id="flipcardsEEvaluation"> ' + _("Informe de progreso") + '. </label> \
							<label for="flipcardsEEvaluationID">' + _("Identificador") + ':\
