...
var TinyMCE_PastePlugin = {
	...
	//		content = content.replace(/<p>&nbsp;<\/p>/gi, '');
			...
			//JR
			content = content.replace(new RegExp('<style.*</style>', 'g'), "")
			content = content.replace(/align="RIGHT"/g, "align=\"right\"")
			content = content.replace(/align="LEFT"/g, "align=\"left\"")
			content = content.replace(/align="JUSTIFY"/g, "align=\"justify\"")
			content = content.replace(/align="CENTER"/g, "align=\"center\"")
			content = content.replace(new RegExp('valign=\"[^\"]*\"', 'g'), "")
			content = content.replace(new RegExp('<table[^>]*>', 'g'), "<table class=\"tabla\">")
			content = content.replace(new RegExp('<td.*width=\"[^\"]*\">', 'g'), "<td>")
			content = content.replace(new RegExp('<col[^>]*>', 'g'), "")
