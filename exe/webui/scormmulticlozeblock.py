...
# Copyright 2009 http://www.lernmodule.net/
...
from exe.webui.element import ScormMultiClozeElement, TextAreaElement
...
g_blockFactory.registerBlockType(ScormMultiClozeBlock, ScormMultiClozeIdevice)    
