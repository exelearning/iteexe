...
from exe.webui.element     import ScormDropDownElement,TextAreaElement
...
# ===========================================================================
class ScormDropDownBlock(Block):
    """
    ...
    def __init__(self, parent, idevice):
        ...
        self.ScormDropDownElement = ScormDropDownElement(idevice.content)
    ...
    def renderEdit(self, style):
        ...
        html = [
            ...
            self.ScormDropDownElement.renderEdit(),
...
#            if self.previewing: 
#                clozeContent = self.ScormDropDownElement.renderPreview(feedbackID)
#            else: 
#                clozeContent = self.ScormDropDownElement.renderView(feedbackID)
#        else:
        if self.previewing: 
            clozeContent = self.ScormDropDownElement.renderPreview()
        else:
            clozeContent = self.ScormDropDownElement.renderView()
        instruction_html = ""
        if self.previewing: 
...
#                                                     class_="feedback"))
    ...
    def renderText(self): 
        ...
        html += '<p>' + self.ScormDropDownElement.renderText() + '</p>'
#        if self.feedbackElement.field.content:
...
#                                                        class_="feedback") 
#                html += '</p>'
        html += self.ScormDropDownElement.renderAnswers()
        return html

from exe.engine.scormdropdownidevice import ScormDropDownIdevice
from exe.webui.blockfactory  import g_blockFactory
g_blockFactory.registerBlockType(ScormDropDownBlock, ScormDropDownIdevice)
