...
as these can tend to be ambiguous.""")
        self._optionInstruc        = _(u"""Enter an answer option. Provide 
...
Click on the &lt;Add another option&gt; button to add another answer.""")
        self._correctAnswerInstruc = _(u"""To indicate the correct answer, 
...
class QuizTestIdevice(Idevice):
    ...
    def __init__(self):
        ...
        Idevice.__init__(self,
                         ...
                         _(u"""Unlike the MCQ the SCORM quiz is used to test 
