...
# Copyright 2012 lernmodule.net, http://www.lernmodule.net/
...
"""
ScormMultiCloze Idevice. Shows a paragraph where the student must fill in the blanks. There are multiple correct answers possible.
"""
...
# ===========================================================================
class ScormMultiClozeIdevice(Idevice):
    """
    ...
    def __init__(self, parentNode=None):
        ...
        """
        Idevice.__init__(self, x_(u"SCORM Test Cloze (multiple options)"),
