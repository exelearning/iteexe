...
class FixedLatin1Prober(latin1prober.Latin1Prober):
    """
    La clase Latin1Prober baja a la mitad la confidence para mejorar los
    resultados de otros probers. Dejamos la confidence en su valor real.
    """
...
def detect(aBuf):
    """
    Autodetecta la codificación de una cadena usando FixedUniversalDetector
    """
...
def relpath(path, start):
    """
    Implementa os.path.relpath independientemente del sistema y arregla un
    fallo cuando start una unidad en windows
    """
...
def nt_relpath(path, start=curdir):
    """
    Implementa os.path.relpath para Windows ya que en python 2.5
