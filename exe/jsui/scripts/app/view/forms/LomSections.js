        ...
        items: function() {
	        ...
	        'lifeCycle': [
	            ...
	            eXe.view.forms.LomWidgets.field(_('Contribution'), true, true, [
	                ...
	                eXe.view.forms.LomWidgets.helpdate( _('Date'), this.prefix + 'lifeCycle_contribute{1}_date', null, null, true)
	            ])
	        ],
	        'metaMetadata': [
	            ...
	            eXe.view.forms.LomWidgets.field(_('Contribution'), true, false, [
	                ...
	                eXe.view.forms.LomWidgets.helpdate( _('Date'), this.prefix + 'metaMetadata_contribute{1}_date', null, null, true)
	            ])
	        ],
	        'technical': [
	        ...
	        'annotation': [
	            ...
	            eXe.view.forms.LomWidgets.field( _('Date'), false, false, eXe.view.forms.LomWidgets.helpdate( null, this.prefix + 'annotation_date', _('Date'), null, true)),
	        ...
	        'classification': [
	            ...
	            eXe.view.forms.LomWidgets.field( _('Taxon Path'), true, true, eXe.view.forms.LomWidgets.helpcombo( null, this.prefix + 'classification_taxonPath{1}', _('Taxon Path'), null, true)),
