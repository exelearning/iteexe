...
Requires: python >= %{pyver}, python-setuptools, python-imaging, python-zope-interface, python-chardet, python-lxml, python-feedparser, mimetex, python-BeautifulSoup, python-suds, python-requests-oauthlib, python-dateutil, python-cssmin, python-webassets
