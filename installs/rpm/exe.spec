...
Requires: python >= %{pyver}, python-setuptools, python-pillow, python-zope-interface, python-chardet, python-lxml, python-feedparser, mimetex, python-beautifulsoup4, python-suds, python-requests-oauthlib, python-dateutil, python-cssmin, python-webassets, python-rjsmin
