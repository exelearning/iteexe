...
class TestPromise(unittest.TestCase):
    ...
    def test1(self):
        ...
        d.callback(t)
        self.assertEqual(t.calls, [("one", 12)])
    ...
    def testFailure(self):
        ...
        self.assertEqual(wresults, ([],[f]))
        self.assertEqual(cresults, ([],[f])) # TODO: really?
