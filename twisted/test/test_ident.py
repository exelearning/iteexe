...
class ClassParserTestCase(unittest.TestCase):
    def testErrors(self):
        ...
        self.assertTrue(L[0].value.__class__ is ident.IdentError, "%s is the wrong exception" % (L[0],))
        ...
        self.assertTrue(L[0].value.__class__ is ident.NoUser, "%s is the wrong exception" % (L[0],))
        ...
        self.assertTrue(L[0].value.__class__ is ident.InvalidPort, "%s is the wrong exception" % (L[0],))
        ...
        self.assertTrue(L[0].value.__class__ is ident.HiddenUser, "%s is the wrong exception" % (L[0],))
    ...
    def testLostConnection(self):
        ...
        self.assertTrue(L[0].value.__class__ is ident.IdentError)
